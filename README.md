...
**Returns** a new TimeSeriesClient that supports the following functions:
...
Writes data to the store for the given dataSourceID at the given timestamp. Timestamp should be in milliseconds since the unix epoch on insert.
