    ...
    const zestClient = {
        ...
        StopObserving: function (path) {
            if (zestClient.Observers[path]) {
                ...
                zestClient.Observers[path]['EE'].removeAllListeners('data')
                zestClient.Observers[path]['EE'].removeAllListeners('error')
                zestClient.Observers[path]['EE'].removeAllListeners('end')
                zestClient.Observers[path]['EE'].removeAllListeners('connect')
                zestClient.Observers[path]['EE'].removeAllListeners('close')
